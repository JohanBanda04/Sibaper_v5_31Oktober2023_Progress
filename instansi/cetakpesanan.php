...
?>
    ...
    <div class="kiri">
        <?php
            ...
            while($item = mysqli_fetch_array($sql)){
                ...
                while($itm = mysqli_fetch_array($q_sql)){
                    ...
                    $jabatan_detail = $itm['jabatan_detail'];
        ...
        <p> </p>
        <p>Diminta Oleh :<br><?= $jabatan_detail." ".$nama_subbid; ?> </p>
        <p></p>
        <p></p>
...
<!--        <p>Disetujui Oleh :<br>Lurah </p>-->
        ...
        include "../fungsi/koneksi.php";
            ...
            while ($dt_kasub_operator = mysqli_fetch_array($query_get_users)){
                ...
                $jabatan_detail_kasub_operator = $dt_kasub_operator['jabatan_detail'];
                $nik_kasub_operator = $dt_kasub_operator['nik'];
                $subbidang_id_kasub_operator = $dt_kasub_operator['subbidang_id'];

                $get_dt_subbidang_kasub_operator = mysqli_query($koneksi,"select * from subbidang 
where id_subbidang='$subbidang_id_kasub_operator'");
                $result_dt_subbidang_kasub_operator = mysqli_fetch_assoc($get_dt_subbidang_kasub_operator);

                $nama_subbidang_kasub_operator = $result_dt_subbidang_kasub_operator['nama_subbidang'];

            }
        ?>
        <p>Disetujui Oleh :<br><?php if($nama_jabatan=="Kasub Operator"){
            echo $jabatan_detail_kasub_operator." ". $nama_subbidang_kasub_operator;
            } ?> </p>
        <p></p>
        <p> </p>
