...
//        echo $val->status_sekarang."<br>";
        ...
        } else if ($val->status_sekarang == 'ini sudah bukan setuju kasub pengguna' || $val->status_sekarang == 'ini bukan setuju kasub pengguna') {
...
status_acc in('Pengajuan Bendahara')");
    ...
    //echo count($array_setuju_kasub_pengguna); die;
...
//            $mail->MsgHTML("Halo, ".$dt_nama_lengkap_bendahara." Terdapat Permohonan Permintaan Barang Pengguna ke Pengelola daris ".$_SESSION['nama_lengkap'].", pada tanggal ".tanggal_indo($tgl_sekarang).",  segera cek aplikasi SIBAPER melalui akun Anda"); //pesan
//
//            $mail->Send();
//
//        }
                    ...
                    <div class="table-responsive">
                        <table class="table text-center">
                            ...
                            <tr>
                                ...
                                <th hidden style="color: black">Aksi</th>
                                ...
                                while ($row = mysqli_fetch_assoc($query)) { ?>
                                    <form method="post" action="permintaan_ke_bendahara_table.php">
                                        ...
                                        <tr>
                                            ...
                                            <td hidden title="Ajukan Ke Bendahara Barangs">
                                                <center>
