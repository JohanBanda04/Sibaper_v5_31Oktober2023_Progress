...
subbidang_id='$result[subbidang_id]' and jabatan='Kasub Pengguna'");
                ...
                if($query_get_kasub){
                    ...
                    $get_subbidang_id_kasub_pemohon = mysqli_query($koneksi,"select * from subbidang
where id_subbidang='$result[subbidang_id]' ");

                    $result_subbidang_id_kasub_pemohon = mysqli_fetch_assoc($get_subbidang_id_kasub_pemohon);
                } else {
        ...
        ?>
        <br>
        <p>Diminta Oleh :<br><?php echo $res['jabatan_detail']?> <?php echo $result_subbidang_id_kasub_pemohon['nama_subbidang'];?></p>
        <br>
        <br>
        <br>
