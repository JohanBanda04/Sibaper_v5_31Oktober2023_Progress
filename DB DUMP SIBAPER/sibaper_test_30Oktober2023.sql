...
-- ----------------------------
INSERT INTO `pengeluaran` VALUES (79, 'wika', 50, '000002', 3, '2023-10-30', 485);
INSERT INTO `pengeluaran` VALUES (80, 'wika', 50, '000002', 2, '2023-10-30', 487);
...
) ENGINE = MyISAM AUTO_INCREMENT = 381 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of permintaan
-- ----------------------------
INSERT INTO `permintaan` VALUES (380, 'wika', 50, 'pengguna', '000002', 1, 2, '2023-10-30', 1, 487);
INSERT INTO `permintaan` VALUES (379, 'wika', 50, 'pengguna', '000002', 1, 3, '2023-10-30', 1, 485);
...
) ENGINE = MyISAM AUTO_INCREMENT = 488 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sementara
-- ----------------------------
INSERT INTO `sementara` VALUES (487, 'wika', 50, 'pengguna', '000002', 1, 2, '2023-10-30', 'Selesai', 0, 0, 1, 11, 'abdul2', 54, NULL, NULL, NULL, 'assets/file/11x.jpeg');
INSERT INTO `sementara` VALUES (486, 'wika', 50, 'pengguna', '000004', 1, 1, '2023-10-30', 'tidak_setuju', 0, 0, 0, 11, NULL, NULL, NULL, 'koreksis', NULL, NULL);
INSERT INTO `sementara` VALUES (485, 'wika', 50, 'pengguna', '000002', 1, 3, '2023-10-30', 'Selesai', 0, 0, 1, 11, 'bendahara1', 58, NULL, 'korek', NULL, 'assets/file/WhatsApp Image 2023-10-12 at 09.46.14.jpeg');
...
-- ----------------------------
INSERT INTO `stokbarang` VALUES (75, '000002', 54, 'abdul2', 1, 'BOLPOINT SNOWMAN V-1', '22000', 'BH', 20, 5, 15, '', '2023-10-02');
...
INSERT INTO `stokbarang` VALUES (140, '020025', 54, 'abdul2', 4, 'KEMUCING COKLAT SUPER', '132000', 'BH', 20, 0, 20, '', '2023-10-02');
...
INSERT INTO `user` VALUES (52, 'dani', 'Muhammad Dani F.', '199911042020121001', '21232f297a57a5a743894a0e4a801fc3', 'pengguna', 'Pengguna', 'Staf', 10, 'hidupsehat973@gmail.com');
