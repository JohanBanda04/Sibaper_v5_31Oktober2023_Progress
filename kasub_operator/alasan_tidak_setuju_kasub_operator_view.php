...
//echo "<pre>"; print_r(mysqli_fetch_assoc($query)); die;
                ...
                <form method="POST"  action="simpan_catatan_tidak_setuju_kasub_operator.php" class="form-horizontal">
                    <div class="box-body">
                        <div hidden class="form-group ">
                            <label for="nama_bendahara" class="col-sm-offset-1 col-sm-3 control-label">NNama Bendahara</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <input type="submit" name="simpan_catatan_tidak_setuju_kasub_operator"
                                   ...
                                   class="btn btn-primary col-sm-offset-4 " value="Simpans" >
                            &nbsp;
